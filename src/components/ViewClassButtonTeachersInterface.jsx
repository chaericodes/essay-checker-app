...
import "./ViewClassButtonTeachersInterface.css";

function ViewClassButtonTeachersInterface() {
  return (
              ...
              <div className="row">
                ...
                <div className="col">
                  ...
                  <button type="button" id="essay-btn">
                    <Link to="/teachersInterface" id="essay-lnk">
                      Essay Checker
                    </Link>
                  </button>
                </div>
            ...
            <div className="container content">
              <div className="row">
                ...
                <div className="col d-flex justify-content-start">
                  ...
                  >
                    <Link to="/viewClassTeachersInterface" id="back-view-lnk">
                      🡠
                    </Link>
                  </button>
              ...
              <div className="row">
                ...
                <div className="col-10 d-flex justify-content-between">
                  <h5 id="email">chayryjoy.bustamante@tup.edu.ph</h5>
                </div>
              </div>
            </div>
            <div className="container questions">
              <div className="row">
                <div className="col-4 view-class-box">
                  <div className="row">
                  ...
                  <div className="col bottom">
                    <div className="row">
                      <div className="col-2 bottom-score">Score:</div>
                      <div className="col-5 bottom-overallScore"> 96/100</div>
                    </div>
                  </div>
                </div>
              </div>
...
export default ViewClassButtonTeachersInterface;
