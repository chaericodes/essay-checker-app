          ...
          >
              ...
              <div className="row">
                <div className="row">
                  ...
                  <div className="col view-classname">
                    ...
                    <div className="row">
                      {" "}
                      <div className="col-6 viewAns-classname">Class name:</div>
                      <div
                        className="col-6 d-flex viewAns-classname"
                        id="viewAns-classSec"
                      >
                        BSCS-NS-4A
                      </div>
            ...
            <div className="row">
              ...
              >
                ...
                <div className="container main-answer">
                  <p>
                    {" "}
                    ...
                    dui sapien eget mi proin sed libero enim sed faucibus turpis
              ...
              <div className="col-4 bar-criteria border border-success">
                Criteria
                <div className="container criteria-wrapper">
                  <div className="col overall-score">
                    {" "}
                    <div className="row">
                      <div className="col numerator">96</div>
                      <div className="col over">/100</div>
                    </div>
                    <div className="row">
                      <div className="col score-num">OVERALL SCORE</div>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col clarity">
                      <div className="row">
                        <div className="col side-numerator">0</div>
                        <div className="col side-over">/20</div>
                      </div>
                      <div className="row">
                        <div className="col criteria-label">clarity</div>
                      </div>
                      <div className="row">
                        <div className="col criteria-feedback">
